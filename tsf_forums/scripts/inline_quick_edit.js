function TSQuickEditPost(GetIDValue,GetThreadID,GetRedirectURL)
{originalhtml=TSGetID(GetIDValue).innerHTML;PostID=GetIDValue.replace(/post_message_/,"");ThreadID=GetThreadID;originalID=GetIDValue;AdvancedEdit=GetRedirectURL;TSGetID(originalID).innerHTML='<img src="./images/spinner.gif" border="0" class="inlineimg"> <strong>'+l_pleasewait+'</strong>';GETRequest('action=quick_edit&pid='+PostID+'&tid='+ThreadID,'tsf_ajax.php');}
...
{document.quick_edit_form.submit.disabled=true;document.quick_edit_form.submit.value=l_pleasewait;var cbobject=document.quick_edit_form.newContent.value;POSTRequest('action=save_quick_edit&text='+encodeURIComponent(cbobject)+'&pid='+PostID+'&tid='+ThreadID,'tsf_ajax.php');}