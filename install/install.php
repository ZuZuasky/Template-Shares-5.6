<?php
  ...
  function html_header ($title = 'DAKz Instalation Wizard', $content = '', $step = '')
  {
...
<div id="wrapper">
		<div id="header">
			<div id="logo"></div>
<div id="searcharea">' . date ('F j, Y, g:i a') . '<br>DAKz Instalation wizard v.' . INSTALL_VERSION . '<br><br><b>' . $step . '</b></div>
		</div>
...
<center><table class="outer"width="75%" border="0" cellpadding="10" cellspacing="0">
							<tr>
  ...
  function step_0 ()
  {
	...
	' . SCRIPT_VERSION . ' requires PHP 4.1.2 or better, ioncube installed and configured, and an MYSQL database.<br /><br />
    ...
    echo html_header ('Welcome to DAKz\'s installation wizard for ' . SCRIPT_VERSION, $_step_0_contents, 'Welcome Screen');
    echo html_footer ();
  }
  ...
  function step_1 ()
  {
    ...
    {
      $_step_1_contents .= next_button (2, ' DAKz\'s installer has detected some problems with your server environment, which will not allow ' . SCRIPT_VERSION . ' to operate correctly. Please correct these issues and then refresh the page to re-check your environment.', true);
    }

    echo html_header ('Welcome to  DAKz\'s  installation wizard for ' . SCRIPT_VERSION, '
	' . $_step_1_contents . '
	', 'Requirements Check');
    echo html_footer ();
  }
  ...
  require_once THIS_ROOT_PATH . 'create_tables.php';
    ...
    echo html_header ('Welcome to  DAKz\'s installation wizard for ' . SCRIPT_VERSION, FALSE, 'Table Creation');
...
';
  ...
  function step_4 ()
  {
    ...
    echo html_header ('Welcome to DAK\'s installation wizard for ' . SCRIPT_VERSION, FALSE, 'Populate Tables');
    echo '                                                  ';
    echo '                                                  ';
    echo '                                                  ';
    echo '                                                  ';
  ...
  function step_7 ()
  {
// <---------------------------------------------->Update Paypal nfo below<-------------------------------->
   $_step_7_contents = SCRIPT_VERSION . ' has successfully been installed and configured correctly. thank you for your support. <br><br><div class=warnbox>After a successful login, please goto settings panel and configure your tracker otherwise Torrent Grabber won\'t work correctly! (first update all cache files, inside settings panel)<br><br>Click <a href="http://' . INSTALL_URL . '">here</a> to login.<br><br>DO NOT FORGET TO DELETE INSTALL FOLDER !!!<br><br>if you like what i do then please donate<br>Greetz from DAKz<br><br>
 <center><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="GU36Y5HC95UPY">
<input type="image" src="https://www.paypalobjects.com/fr_FR/FR/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal -  Payment is simple and secure !">
<img alt="" border="0" src="https://www.paypalobjects.com/fr_FR/i/scr/pixel.gif" width="1" height="1">  
  ...
  define ('SCRIPT_VERSION', 'Torrent Grabber Tracker v.1.0');
