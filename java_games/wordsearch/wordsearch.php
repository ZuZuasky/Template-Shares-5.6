...
<?
print("	<table class='main' border='1' cellpadding='10' cellspacing='1' width='100%'><tr><td class='embedded'>
		<table width='100%' border='1' cellspacing='1' cellpadding='10'>
		<tr><td style='padding: 4px; background: url(../images/mainbox_bg.jpg) repeat-x left top' border='1' cellpadding='10' cellspacing='1' width='100%'>\n");
	echo '<strong><center><font color="#ffffff" face="Arial,Helvetica" size="4">'.$SITENAME.' '.$lang->tsse_games['java_games36'].'</font></center></strong>';
...
print("	<tr><td style='padding: 4px; background: url(../images/mainbox_bg.jpg) repeat-x left top'>
	...
	echo '<table class="main" border="1" cellspacing="1" cellpadding="10" width="100%"><tr><td class="embedded">';
	echo '<table width="100%" border="1" cellspacing="1" cellpadding="10">';
...
<font color="#cc6600" face="Arial,Helvetica" size="4"><b>'.$lang->tsse_games['java_games37'].'</b>
</font></center></td></tr>';
...
<param name="files" value="animals.txt,countries.txt,measures.txt,movies.txt,nightsky.txt">
</applet>
<p>
		</BODY>
			</HTML>
