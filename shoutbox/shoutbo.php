...
<br />
';
  if ((($is_mod AND is_valid_id ($_GET['id'])) AND $_GET['do'] == 'edit'))
  {
    $id = intval ($_GET['id']);
  ...
  {
    if ((($is_mod AND is_valid_id ($_POST['id'])) AND $_POST['do'] == 'save'))
    {
      $id = intval ($_POST['id']);
    ...
    {
      if ((($is_mod AND is_valid_id ($_GET['id'])) AND $_GET['do'] == 'delete'))
      {
        $id = intval ($_GET['id']);
